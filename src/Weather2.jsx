                                    ...
                                    <div className="accordion-card">
                                        {groupedByDay[day].map((item, index) => (
                                            <div className='container'>
                                                <div className='row '>
                                                    <div v key={index} className="card col-md-4">
                                                        <div >
                                                            <h5 className="card-title">{new Date(item.dt_txt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</h5>
                                                            <p className="card-text">Temperature: {item.main.temp} °C</p>
                                                            <p className="card-text">Weather: {item.weather[0].main}</p>
                                                            <p className="card-text"> <img src={`http://openweathermap.org/img/w/${item.weather[0].icon}.png`} alt="wthr img" /></p>
